...
Function Start-CMClientAction
{
    ...
    Process
    {
        ...
        If (!($PSBoundParameters.Keys.Contains('SCCMActionsBundle')))
        {
            ...
            {
                $sccmcommand = Invoke-Command -ComputerName $Computer -ScriptBlock -ConfigurationName Microsoft.PowerShell { Invoke-WmiMethod -Namespace root\CCM -Class SMS_CLIENT -Name TriggerSchedule -ArgumentList $ClientAction }
            }
        }
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCCveuymXFWpHvIS
# P6JQo1r9xuee4+ETCn25ssJHEyvPt6CCEp8wggPHMIICr6ADAgECAhAiSLvsHK6q
...
# BAGCNwIBBDAvBgkqhkiG9w0BCQQxIgQgX0iXvTkha8M7jxoYeU6rBsBT8tjoEehP
# Tu6/K5LZdpIwDQYJKoZIhvcNAQEBBQAEggEAKO3yu96maRlXcGGMZXyXkLxebccR
# KS8pivpB5eCw0Pq0ZYpT1RhKSmbH3sSExkWg8ol0bzJnd+nABhwRhL1aTTRlz4+M
# 6xQ8PsTDc6m76wiBwDJhbwbBd/qI0HGzLpfsYzs8wbvihfdtMFNBmfga942lmzMh
# lyStmOLo2hvDMf2WDXUvx8HmE9uqg3aOd5DqyGdBhs/iDcD2itMR4Xbdnb7KWXAx
# 6MPJ9IiyGZWvtDBpDLtJ80MWXMpjNTy3C7Vc1ZWnuq/AZJutZknzzTY2DxfDVKtK
# 3UjRWXRcZjVxQ9LAQcszJvla684LpvmzZe0Jjinl9bVGciG7lk2buOoQE6GCArkw
...
# MQ8XDTE5MDEwNDE1NDI0MFowLwYJKoZIhvcNAQkEMSIEIBQGd1cx284+4cT9ZHCt
# cgRRdLAU+jMvqEl0CsF78Li7MIGgBgsqhkiG9w0BCRACDDGBkDCBjTCBijCBhwQU
...
# AQEFAASCAQC9aw2mYPkHweknChrDgrE72aOTxEDUs6SCHjdxcF9IPmgkhW4/W3V9
# SnNYZ42totlqf5tN9YA/zy1K4VAJwbnR5adJSrSw59PzTG0rsQvu/QqZoIkQNskn
# sAiW6Aa7U6MycRPlfKjicMuxjsdwcI2JxJJ05U+XNrt5VDOEPTydrzwsZ1eKb8MV
# Kux6Hh18Jk7d+Agi0sMC0mcO2cvaYA2YNKL714KUN5xGetSXqKHXjR8WHj8LwAoY
# SlbN8mMQw32Uk399lbcPQxA4w5FoINdjPmWE5OiBET0j0cVPRkQkyXRXkLkjmRso
# KBTeYBvmiLCTbeFGErzYoEmUZ+YFdHOs
